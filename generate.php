...
// Validar token CSRF no início de tudo
...
if (!empty($hostids)) {
    ...
    foreach ($hostids as $hid) {
        ...
        //   -> só match com vfs.fs.size[/boot,ext4,pfree], não total nem used.
...
try {
    ...
    ztrace("FALHA GRAVE AO GERAR PDF: " . $e->getMessage() . "\n" . $e->getTraceAsString());
    http_response_code(500);
    header('Content-Type: text/html; charset=UTF-8');
