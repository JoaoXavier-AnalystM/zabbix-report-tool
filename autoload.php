<?php
/**
 * Autoloader personalizado para carregar as dependências sem depender do Composer
 */

// Evitar que seja carregado múltiplas vezes
...
// Definir o fuso horário se não estiver configurado
...
// Inicializar dompdf se disponível
if (class_exists('Dompdf\Dompdf')) {
    // Configuração adicional do dompdf se necessário
}
