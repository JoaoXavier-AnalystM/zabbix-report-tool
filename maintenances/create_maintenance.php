...
// ============================================================
// LÓGICA DE PERMISSÕES ADAPTADA À VERSÃO
// ============================================================
if (version_compare($zabbix_version, '6.4', '<')) {
    // Zabbix 6.0: tipo 1 também pode criar
    $can_create = ($user_type == 1 || $user_type >= 2);
} else {
    // Zabbix 6.4+: apenas tipos 2 e 3
    ...
    <div class="card">
      ...
      <div id="tab-main" class="tab-content active">
        ...
        <div class="form-group">
            ...
            <div style="font-size:11px;color:var(--text3);margin-top:4px;font-family:var(--mono)"><?= t('maint_hosts_hint') ?></div>
        </div>
        <div class="form-group">
...
<template id="template-period-4">
  <!-- * Month — sempre visível em ambos os modos -->
...
<script>
    ...
    form.addEventListener('submit', e => {
        ...
        $$('.period', periodsList).forEach(periodEl => {
            ...
            if (periodType === '4') {
                // Limpar o que foi colocado pelo loop genérico
                ...
                // Duração a partir de dias+horas
                ...
                // Detectar modo por data-active no botão (mais confiável que style)
