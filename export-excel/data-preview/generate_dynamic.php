 ...
 * Gera o CSV dinâmico: coluna HOST + uma coluna por cada item selecionado.
 * Se um host não tiver o item → N/A.
 * Fluxo: recebe hostids + itemids[] + item_names[] → consulta lastvalue → CSV.
 */
...
try {
    ...
    // ── Fetch de todos os itens por key_ exata em todos os hosts ──
    ...
    // Agrupar itens por display_name — vários itemids com o mesmo nome
