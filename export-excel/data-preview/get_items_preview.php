 ...
 * Endpoint AJAX para o Data Preview Export.
 * Ações:
 *   - get_host_items : retorna a união de itens dos hosts selecionados
 *   - preview        : retorna lastvalue dos itens selecionados por host
 */
...
try {
    ...
    // Retorna a UNIÃO de itens de todos os hosts selecionados.
    ...
    if ($action === 'get_host_items') {
        ...
        // Remover duplicados por key_ — cada chave única aparece uma vez na lista.
        // A fusão por display_name ocorre apenas ao gerar o CSV.
        $seen_keys = [];
        $result    = [];
    ...
    echo json_encode(['error' => 'Ação não reconhecida: '.htmlspecialchars($action)]);
